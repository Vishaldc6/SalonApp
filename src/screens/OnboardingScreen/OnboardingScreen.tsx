...
import { StyleSheet, View, FlatList, Image, ImageSourcePropType, Alert } from 'react-native';
    ...
    <View style={globalStyles.appContainer}>
      ...
      <View style={styles.indicatorRowContainer}>
        {onBoardingData.map((_, index) =>
          <View style={[styles.indicator, index == currentScreenIndex ? styles.activeIndicator : styles.inActiveIndicator]}
          />)}
      </View>

      <PrimaryCustomButton
        title={currentScreenIndex !== onBoardingData.length - 1 ? AppStrings.onboarding.next : AppStrings.onboarding.get_started}
